...
import { AccordionFeature, Benfit, FeatureCard, InfoAccordion, MobileSection, sub } from '@/types';
...
const columnHelper = createColumnHelper<AccordionFeature>();
...
export const defaultColumns = [
  ...
  columnHelper.accessor('subFeatures', {
    ...
    cell: ({ row }) => (
      <ul>
        {row.original.subFeatures?.map((item: any, index: number) => (
          <li key={`${index}_name`}>
            {item.name}
          </li>
        ))}
