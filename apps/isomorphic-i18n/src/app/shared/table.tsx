...
const classes = {
  table:
    "[&_.rc-table-content]:overflow-x-auto [&_table]:w-full [&_.rc-table-row:hover]:bg-green-100 [&_.rc-table-row-expand-icon-cell]:w-14",
  thead:
  ...
  tCell:
    "[&_.rc-table-cell]:px-3 [&_tr.rc-table-cell]:text-red-400 [&_th.rc-table-cell]:py-3 [&_td.rc-table-cell]:py-4",
  variants: {
    classic:
    ...
    modern:
      "[&_thead_th]:bg-gray-100 [&_tr.rc-table-cell]:text-red-400 [&_td.rc-table-cell]:text-red-400 [&_td.rc-table-cell]:dark:text-red-400 [&_td.rc-table-cell]:border-muted/70 [&_thead_.rc-table-row-expand-icon-cell]:bg-gray-100",
    minimal:
