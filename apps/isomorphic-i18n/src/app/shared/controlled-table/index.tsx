...
export default function ControlledTable({
  ...
  if (isLoading) {
    ...
    return (
      <div className="grid h-ful min-h-[128px] flex-grow place-content-center items-center justify-center">
  ...
  return (
    <>
      ...
      <div className="relative  custom-scrollbar-x grid grid-flow-col  overflow-x-auto scroll-smooth">
        <Table
