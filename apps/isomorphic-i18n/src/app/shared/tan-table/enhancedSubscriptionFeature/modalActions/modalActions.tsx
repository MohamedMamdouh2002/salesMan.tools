...
import { deleteSubscriptionFeature } from '@/lib/api/getSubscription';
...
interface ActionsCellProps {
  ...
  const ModalAction: React.FC<ActionsCellProps> = ({ row, title = '',titleAr='',descriptionAr='', description='', deleteId = '',  }, { lang }: { lang?: string }) => {
    // console.log("row: ",row);
  ...
  const handleDelete = (deleteId: string) => {
    deleteSubscriptionFeature(deleteId,setIsUpdate); // Call the delete function here
  };
