...
import { AccordionFeature, Benfit, DocType, DocumentationId, FeatureCard, InfoAccordion, MobileSection, sub, SubscriptionFeature } from '@/types';
...
const columnHelper = createColumnHelper<SubscriptionFeature>();
...
export const defaultColumns = [
  ...
  columnHelper.accessor('userName', {
    ...
    cell:({ row }) => <ModalAction
        ...
        titleAr={row.original.descriptionAr}
