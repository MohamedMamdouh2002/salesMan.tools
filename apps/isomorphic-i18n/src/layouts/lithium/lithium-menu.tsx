  ...
  return (
    <>
      <NavMenu
        ...
        menuClassName=" pb-5  top-3 gap-14 relative  4xl:ps-[390px] xl:ps-[100px] 2xl:ps-[160px] "
        menuContentClassName="mt-2 text-black  border border-red-800 dark:border-gray-300"
        handleMouseEnter={Link} 
      >
        <NavMenu.Item >
          <NavMenu.Trigger  className="flex items-center text-sm  gap-1 pt-2 duration-200 ">
            <Link  lang={lang} href={`/${lang!}/subscriptions`}>
            <MenuTriggerButton  name="Subscriptions" lang={lang}/>
            </Link>
          </NavMenu.Trigger>
        ...
        <NavMenu.Item >
          <NavMenu.Trigger className="flex  items-center gap-1 pt-2  duration-200 ">
            ...
            <MenuTriggerButton name="Features"  />
            </Link>
          </NavMenu.Trigger>
          {/* <NavMenu.Content>
